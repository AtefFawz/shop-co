...
import RoleSelector from "@/components/features/admin/users/RoleSelector"; // 🎯 كومبوننت تعديل الرول
import DeleteUserButton from "@/components/features/admin/users/DeleteUserButton"; // 🎯 كومبوننت المسح
    ...
    <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8 font-sans">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <span className="hidden sm:inline-block text-[10px] font-mono text-gray-400 bg-gray-50 border border-gray-100 px-3 py-1.5 rounded-full">
            ID: {user._id}
          </span>
          {/* 🎯 زرار المسح الاحترافي مع Confirmation */}
