    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F8F8F8]">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-black animate-pulse" />
    ...
    <div className="min-h-screen bg-[#F8F8F8]  py-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-4">
          <button
            onClick={() => router.back()}
            className="w-10 h-10 flex items-center justify-center rounded-xl bg-white border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition-all shadow-sm"
          >
            <ArrowLeft size={18} />
          </button>
          <div>
            ...
            <p className="text-xs text-gray-400 font-medium mt-1 tracking-wide">
              Update product details — changes save immediately
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <FormSection label="Basic Information">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Field label="Product Name" icon={<Tag size={14} />}>
                <input
              ...
              <Field label="Category" icon={<TagIcon size={14} />}>
                <input
                  className="form-input"
                  type="text"
              ...
              <Field label="Section" icon={<Layers size={14} />}>
                <input
                  className="form-input"
                  type="text"
              ...
              <Field label="Product Type" icon={<Layers size={14} />}>
                <input
                  className="form-input"
                  type="text"
          ...
          <FormSection label="Description">
            <Field label="Product Description" icon={<AlignLeft size={14} />}>
              <textarea
          ...
          <FormSection label="Pricing & Sale">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <Field label="Discount (%)" icon={<Percent size={14} />}>
                <input
                  className="form-input"
                  type="number"
                  placeholder="0"
              ...
              <Field label="On Sale?" icon={<Tag size={14} />}>
                <select
                  className="form-input"
                  value={item.isSale}
          ...
          <FormSection label="Specifications">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Field label="Available Sizes" icon={<Ruler size={14} />}>
                <input
                  className="form-input"
                  type="text"
              ...
              <Field label="Available Colors" icon={<Palette size={14} />}>
                <input
                  className="form-input"
                  type="text"
          ...
          <FormSection label="Product Image">
            <label className="relative group flex flex-col items-center justify-center gap-3 border-2 border-dashed border-gray-200 rounded-2xl p-10 text-center hover:border-black hover:bg-gray-50 transition-all cursor-pointer">
              <input
                type="file"
              ...
              />
              <div className="w-12 h-12 bg-gray-100 group-hover:bg-black rounded-2xl flex items-center justify-center transition-colors">
                <ImagePlus
                  size={20}
